...
- Docs: ADR-022 (Goals rename), ADR-023 (charts), ADR-024 (recompute-from-git), ADR-025 (native pages), SPEC-022-A, SPEC-021-B, SPEC-018-B, SPEC-023-A, SPEC-024-A, SPEC-025-A.
