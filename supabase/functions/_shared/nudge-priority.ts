// Nudge Priority Logic for Edge Functions
// Deno-compatible version of src/lib/utils/nudge-priority.ts
...
export function getRecommendedAction(
  ...
  const urgentDeadline = context.upcomingDeadlines.find(
